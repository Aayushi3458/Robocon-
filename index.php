     ...
     <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="form-group mt-3" style="width:80%">
                ...
                <input type="text" id="Email Id" placeholder="Password" required>
        </div>
    <br>
    <div class="text-center"><button type="submit" style="background:green;border-radius:5px;border:none;width:10%;color:white">Login</button></div>
